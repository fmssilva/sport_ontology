...
public class CreateH2Database {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Clean existing tables (reverse order due to FK constraints)
            // Note: We drop tables (not entire DB) to preserve AUTO_SERVER connection
            // and allow concurrent access by Ontop CLI during testing
            ...
            // OWA vs CWA Test Case: Contract with uncertain active status (NULL)
            stmt.execute("INSERT INTO contract VALUES (8, 9, 5, 'PermanentContract', '2022-07-01', '2027-06-30', 8000000, NULL)");
            ...
            System.out.println("- 13 contratos (incluindo 1 com status incerto para testes OWA/CWA)");
            System.out.println("\n=== RECURSOS PARA TESTES OWA vs CWA ===");
